...
def test_bq(sda, ):
    ...
    if a == "1":
        ...
        while True:
            ...
            print("IN Stat: {}, vbus:{}.{}, in Imax:{}, in U:{}".format(bq25895.pg_stat_str(), bq25895.vbus_type(),
                  bq25895.vbus_type_str(), bq25895.read_input_current_max(), bq25895.read_vbus_volt()))
            print("Bat stat:{}, I:{}, V:{}".format(bq25895.chrg_stat_str(),
                  bq25895.read_charge_current(), bq25895.read_battery_volt()))
